...
const submitApplicationForReview = ".css-t7nm82";
...
class SummaryPage {
    ...
    datasetBoundaryValueCheck() {
        commonUtil.clickBtn(addButton, "get");
        commonUtil.xpathType(abstract, "tes1");
        commonUtil.xpathType(contactPoint, "gatewaycustodian@gmail");
        commonUtil.clickBtn(submitApplicationForReview, "get");
        commonUtil.popupWindowValidation();
        commonUtil.clickBtn(addButton, "get");
        cy.xpath(abstractErrorText)
